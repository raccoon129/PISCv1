...
function abrirDetallesPrestamo(numeroVale) {
    var url = 'detallesPrestamo.php?numeroVale=' + numeroVale;
...
function abrirExportarHistorialCSV(){
    var url = "historialPrestamosExportarHistorial.php";
