...
$queryVale = "SELECT v.*, d.Nombre AS NombreDeudor, d.Rol, u.nombrecompleto AS NombreUsuario
              FROM vale v
...
<body>
    <div class="container mt-3">
        ...
        <div><strong>Persona que entrega:</strong> <?= htmlspecialchars($detalleVale['NombreUsuario']) ?></div>
